...
import {ProjectDescriptor} from "../../lib/context/downloads";
...
const SoftwareDownloadButton = ({
  ...
  const [timeoutHandler, setTimeoutHandler] = useState<number | null>(
    null
  );
    ...
    <Menu as="div" className="relative">
      ...
      >
        ...
        <a
          ...
          target="_blank"
        >
          <DocumentDownloadIcon className={compact ? "w-4 h-4" : "w-8 h-8"} />
